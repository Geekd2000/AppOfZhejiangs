...
public class HotStrategy2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hot_strategy2);
        //设置沉浸式
    ...
    private void setTourismPublicityTitle() {
        this.tourismPublicityTitle.setText("杭州西湖游览路线推荐");
