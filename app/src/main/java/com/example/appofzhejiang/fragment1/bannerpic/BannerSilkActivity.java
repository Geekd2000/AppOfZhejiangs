...
public class BannerSilkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banner_silk);
        //设置沉浸式
    ...
    private void setTourismPublicityTitle() {
        this.tourismPublicityTitle.setText("“2020丝绸之路周”展览吸引众多市民参观");
