package com.example.appofzhejiang.fragment1.bannerpic;
...
public class BannerPorcelainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banner_porcelain);
        //设置沉浸式
    ...
    private void setTourismPublicityTitle() {
        this.tourismPublicityTitle.setText("瓷器之起源—新石器时代");
