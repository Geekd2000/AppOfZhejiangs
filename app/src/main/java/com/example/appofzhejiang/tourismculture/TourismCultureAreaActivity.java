...
public class TourismCultureAreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_culture_area);
        // 隐藏系统标题
...
//                Intent intent = new Intent(TourismCultureAreaActivity.this, MainActivity.class);
//                startActivity(intent);
    ...
    private void setTourismPublicityTitle() {
            this.tourismPublicityTitle.setText("初识杭州 | 地域概况");
